...
{
    /// <summary>
    /// Represents the ampersand character ('@'), used internally within the <c>DbConnection</c> class
    ...
    /// <summary>
    /// Represents the semicolon character (';'), used within the <c>DbConnection</c> class
    ...
    /// <summary>
    /// Represents the equal character ('='), used internally within the <c>DbConnection</c>
    ...
    /// <summary>
    /// Parses a connection string and constructs an instance of <c>DbConnection</c>.
