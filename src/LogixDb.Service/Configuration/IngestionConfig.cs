...
public class IngestionConfig
{
    ...
    /// </summary>
    public string DropPath { get; init; } = string.Empty;

    /// <summary>
    /// The connection string to the database that is the target for ingestion.
    /// </summary>
    public string DbConnection { get; init; } = string.Empty;
    ...
    /// </summary>
    public SnapshotAction OnImport { get; init; } = SnapshotAction.ReplaceLatest;
}