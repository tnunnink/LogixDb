...
internal class InstructionMap : TableMap<InstructionRecord>
{
    ...
    [
        ...
        ColumnMap<InstructionRecord>.For(r => r.InstanceId, "instance_id", hashable: false),
...
/// </summary>
internal record InstructionRecord(int InstanceId, Guid RungId, short Index, Instruction Instruction)
{
