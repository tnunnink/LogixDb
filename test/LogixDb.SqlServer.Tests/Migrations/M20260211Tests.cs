namespace LogixDb.SqlServer.Tests.Migrations;
...
public class M20260211Tests : SqlServerTestFixture
{
    ...
    public async Task MigrateUp_ToM009_CreatesRoutineTableWithExpectedColumns()
    {
        ...
        using (Assert.EnterMultipleScope())
        {
            ...
            await AssertColumnDefinition("routine", "scope_type", "nvarchar");
            ...
            await AssertUniqueIndex("routine", "snapshot_id", "container_name", "routine_name", "scope_type");
    ...
    public async Task MigrateUp_ToM010_CreatesRungTableWithExpectedColumns()
    {
        ...
        using (Assert.EnterMultipleScope())
        {
            ...
            await AssertIndex("rung", "snapshot_id", "routine_name", "rung_number");
