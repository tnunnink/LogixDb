...
public abstract class TestDbFixture
{
    ...
    /// </summary>
    protected static DbConnectionInfo Connection => TestEnvironment.Database.Connection;
    ...
    /// </summary>
    protected static IDbManager Manager => new DbManager(new SqliteProvider(Connection));
    ...
    {
        await TestEnvironment.Database.Purge();
    }
}