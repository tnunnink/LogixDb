...
[TestFixture]
public class SqliteDbRestoreTargetTests : SqliteTestFixture
{
    [SetUp]
    ...
    public async Task RestoreTarget_ShouldPopulateRelationalDataFromArchivedTarget()
    {
        ...
        // Retrieve target from database to ensure we have any metadata that might have been updated (like InstanceId, although Post doesn't set it)
