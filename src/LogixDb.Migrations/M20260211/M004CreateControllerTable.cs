...
public class M004CreateControllerTable : AutoReversingMigration
{
    public override void Up()
    {
        Create.Table("controller")
            ...
            .WithColumn("sfc_execution_control").AsString(64).Nullable()
            .WithColumn("sfc_restart_position").AsString(64).Nullable()
            .WithColumn("sfc_last_scan").AsString(64).Nullable()
            .WithColumn("project_sn").AsString(64).Nullable()
