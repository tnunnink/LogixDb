...
{
    public const string Schema = "logix";


    /// <summary>
    /// Sets the schema for the index to the default "logix" schema.
    /// </summary>
    /// <param name="syntax">The fluent migration builder used to define the index.</param>
    /// <returns>Returns the fluent migration builder with the schema set.</returns>
    public static ICreateIndexOnColumnSyntax InLogixSchema(this ICreateIndexOnColumnOrInSchemaSyntax syntax)
    {
    ...
    public static ICreateTableColumnOptionOrWithColumnSyntax WithPrimaryKey<T>(
    ...
    /// <summary>
    /// Sets the schema for the table to the default "logix" schema.
    /// </summary>
    /// <param name="syntax">The fluent migration builder used to define the table schema.</param>
    /// <returns>Returns the fluent migration builder with the schema set.</returns>
    public static ICreateTableWithColumnSyntax InLogixSchema(
