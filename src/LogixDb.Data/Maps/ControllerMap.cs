...
public class ControllerMap : TableMap<ControllerRecord>
{
    ...
    [
        ...
        ColumnMap<ControllerRecord>.For(r => r.Controller.Description, "description"),
        ...
        ColumnMap<ControllerRecord>.For(r => r.Controller.CommPath, "comm_path"),
        ...
        ColumnMap<ControllerRecord>.For(r => r.Controller.ProjectSN, "project_sn"),
